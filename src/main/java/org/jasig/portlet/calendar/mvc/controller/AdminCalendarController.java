...
/**
 * AdminCalendarController provides a main administrative view for the calendar portlet. The page is
 * available to users in the configured "calendarAdmin" role.
 *
 * @author Jen Bourey
 */
@Controller
...
public class AdminCalendarController {
  ...
  public void deleteSharedCalendar(
      ActionRequest request, ActionResponse response, @RequestParam("calendarId") Long id) {
