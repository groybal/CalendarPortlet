...
public class HibernateCalendarStore extends HibernateDaoSupport implements CalendarStore {
  ...
  public List<UserDefinedCalendarConfiguration> getCalendarConfigurations(String subscribeId) {
    try {
      ...
      List<UserDefinedCalendarConfiguration> configurations =
  ...
  public List<UserDefinedCalendarConfiguration> getUserDefinedCalendarConfigurations() {
    try {
      ...
      @SuppressWarnings("unchecked")
      List<UserDefinedCalendarConfiguration> configurations =
          (List<UserDefinedCalendarConfiguration>) getHibernateTemplate().find(query);
      return configurations;
    ...
    try {
      ...
      String query =
          "from CalendarConfiguration config where "
              ...
              + "config.class = UserDefinedCalendarConfiguration "
              + "order by calendarDefinition.name";
      if (visibleOnly) query = query.concat(" and visibleOnly = true");

      @SuppressWarnings("unchecked")
      List<UserDefinedCalendarConfiguration> configurations =
          (List<UserDefinedCalendarConfiguration>) getHibernateTemplate().find(query, subscribeId);
      return configurations;
  ...
  public PredefinedCalendarConfiguration getPredefinedCalendarConfiguration(
    ...
    try {
      String query =
          "from CalendarConfiguration config "
  ...
  public List<PredefinedCalendarConfiguration> getPredefinedCalendarConfigurations(
    ...
    try {
      ...
      @SuppressWarnings("unchecked")
      List<PredefinedCalendarConfiguration> configurations =
          (List<PredefinedCalendarConfiguration>) getHibernateTemplate().find(query, subscribeId);
      return configurations;
  ...
  public List<PredefinedCalendarConfiguration> getPredefinedCalendarConfigurations() {
    try {
      ...
      String query =
          "from CalendarConfiguration conf "
              + "where conf.class = PredefinedCalendarConfiguration ";
      @SuppressWarnings("unchecked")
      List<PredefinedCalendarConfiguration> configurations =
          (List<PredefinedCalendarConfiguration>) getHibernateTemplate().find(query);
      return configurations;
  ...
  public List<PredefinedCalendarDefinition> getHiddenPredefinedCalendarDefinitions(
      String subscribeId, Set<String> roles) {
    try {
      ...
      @SuppressWarnings("unchecked")
      List<PredefinedCalendarDefinition> definitions =
          (List<PredefinedCalendarDefinition>) q.list();
      return definitions;
  ...
  public synchronized void initCalendar(String subscribeId, Set<String> roles) {
    try {
      ...
      String query =
          "from PredefinedCalendarDefinition pcd where pcd.id in "
  ...
  public List<PredefinedCalendarDefinition> getPredefinedCalendarDefinitions() {
    try {
      ...
      @SuppressWarnings("unchecked")
      List<PredefinedCalendarDefinition> definitions =
          (List<PredefinedCalendarDefinition>) getHibernateTemplate().find(query);
      return definitions;
  ...
  public CalendarDefinition getCalendarDefinition(String fname) {
    ...
    try {
      ...
      @SuppressWarnings("unchecked")
      List<PredefinedCalendarDefinition> configurations =
          (List<PredefinedCalendarDefinition>)
              getHibernateTemplate()
                  .find("from PredefinedCalendarDefinition def where " + "def.fname=?", fname);
  ...
  public List<String> getUserRoles() {
    try {
      ...
      String query =
          "select distinct elements(def.defaultRoles) " + "from PredefinedCalendarDefinition def ";

      @SuppressWarnings("unchecked")
      List<String> userRoles = (List<String>) getHibernateTemplate().find(query);
      return userRoles;
